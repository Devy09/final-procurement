    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={() => setOpen(true)} className="text-blue-500">
            <ExternalLink className="mr-2 h-4 w-4" />View Details
          </DropdownMenuItem>
          <DropdownMenuItem 
            onClick={() => setShowApprovalDialog(true)}
            disabled={poDetails?.approvedByAccountant === true}
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <div className="space-y-4">
                          <div className="flex flex-col gap-1">
                            <span className="font-medium text-gray-500">PR Number:</span>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button 
              ...
              disabled={isApproving || poDetails?.approvedByAccountant === true}
